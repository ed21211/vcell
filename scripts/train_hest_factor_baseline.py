...
DATA_NPZ = PROJECT_DIR / "features" / "hest_ccrcc_joined" / "hest_ccrcc_virchow2_factor_dataset.npz"
META_CSV = PROJECT_DIR / "features" / "hest_ccrcc_joined" / "hest_ccrcc_virchow2_factor_metadata.csv"

OUT_DIR = PROJECT_DIR / "outputs" / "hest_factor_baseline"
...
def main():
    print("Loading joined HEST ccRCC dataset...")
