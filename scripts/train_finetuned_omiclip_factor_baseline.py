...
DATA_NPZ = PROJECT_DIR / "outputs" / "omiclip_finetuned_factor_baseline" / "omiclip_finetuned_factor_dataset.npz"
META_CSV = PROJECT_DIR / "outputs" / "omiclip_finetuned_factor_baseline" / "omiclip_finetuned_factor_metadata.csv"

OUT_DIR = PROJECT_DIR / "outputs" / "omiclip_finetuned_factor_baseline"
